...
It also exposes the \verb$GreatestPrimeFactor$ accessors from \verb$itk::FFTPadImageFilter$ to let
...
I'd like to thank the INRA anyway, and more specifically the MIMA2 facility, who
provided the computer ressources used for this work. 
...
\begin{itemize}
 ...
 \item allow the user to create a plan with \verb$FFTW_PATIENT$, \verb$FFTW_MEASURE$, or
